...
def generate_hyperbolic_data(n_samples=200, n_features=5, n_classes=3, 
...
def test_decision_tree_classifier():
    ...
    # Generate data
    X, y = generate_hyperbolic_data(n_samples=200, n_features=5, n_classes=3, 
...
def test_decision_tree_regressor():
    ...
    # Generate data
    X, y = generate_hyperbolic_data(n_samples=200, n_features=5, 
...
def test_random_forest_classifier():
    ...
    clf = HyperbolicRandomForestClassifier(n_estimators=10, max_depth=3, 
                                          timelike_dim=0, skip_hyperboloid_check=True)
    clf.fit(X_train, y_train)
...
def test_random_forest_regressor():
    ...
    # Create and fit model with fewer trees for faster testing
    reg = HyperbolicRandomForestRegressor(n_estimators=10, max_depth=3, 
                                         timelike_dim=0, skip_hyperboloid_check=True)
    reg.fit(X_train, y_train)
...
def test_xgboost_classifier():
    ...
    # Create and fit model with fewer trees for faster testing
    clf = HyperbolicXGBoostClassifier(n_estimators=10, max_depth=3, learning_rate=0.1,
                                     timelike_dim=0, skip_hyperboloid_check=True)
    clf.fit(X_train, y_train)
...
def test_xgboost_regressor():
    ...
    # Create and fit model with fewer trees for faster testing
    reg = HyperbolicXGBoostRegressor(n_estimators=10, max_depth=3, learning_rate=0.1,
                                    timelike_dim=0, skip_hyperboloid_check=True)
    reg.fit(X_train, y_train)
