...
def test_midpoint_override_affects_performance():
    ...
    normal_model = HyperbolicDecisionTreeClassifier(max_depth=5, timelike_dim=0, validate_input_geometry=False)
    ...
    zero_model = ZeroMidpointModel(max_depth=5, timelike_dim=0, validate_input_geometry=False)
